...
@WrappedClass("net.minecraft.client.renderer.entity.RenderIronGolem")
public interface RenderIronGolem {

    ResourceLocation getEntityTexture(Entity var0);

    ResourceLocation getEntityTexture(EntityIronGolem var0);

    void rotateCorpse(EntityLivingBase var0, float var1, float var2, float var3);

    void rotateCorpse(EntityIronGolem var0, float var1, float var2, float var3);
