...
@WrappedClass("net.minecraft.client.model.ModelRabbit")
public interface ModelRabbit {
    ...
    void setRotationOffset(ModelRenderer var0, float var1, float var2, float var3);
