...
@WrappedClass("net.minecraft.client.renderer.entity.layers.LayerSlimeGel")
public interface LayerSlimeGel {

    void doRenderLayer(EntityLivingBase var0, float var1, float var2, float var3, float var4, float var5, float var6, float var7);

    void doRenderLayer(EntitySlime var0, float var1, float var2, float var3, float var4, float var5, float var6, float var7);
