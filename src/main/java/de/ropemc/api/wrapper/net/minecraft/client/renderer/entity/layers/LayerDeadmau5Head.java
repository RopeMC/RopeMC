...
@WrappedClass("net.minecraft.client.renderer.entity.layers.LayerDeadmau5Head")
public interface LayerDeadmau5Head {

    void doRenderLayer(AbstractClientPlayer var0, float var1, float var2, float var3, float var4, float var5, float var6, float var7);
